...
public class GameMoveJumpHandler extends BaseClientRequestHandler {
	...
	public void handleClientRequest(User user, ISFSObject args) {
		...
		send(GameOpcodes.GAME_MOVE_JUMP_START, params, getParentExtension().getParentRoom().getPlayersList());
	}
