...
public class GameMoveStopRightHandler extends BaseClientRequestHandler {
	...
	public void handleClientRequest(User user, ISFSObject args) {
		...
		send(GameOpcodes.GAME_MOVE_STOP_RIGHT, params, getParentExtension().getParentRoom().getPlayersList());
