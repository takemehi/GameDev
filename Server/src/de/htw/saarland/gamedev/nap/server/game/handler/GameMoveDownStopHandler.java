...
public class GameMoveDownStopHandler extends BaseClientRequestHandler {
	...
	public void handleClientRequest(User user, ISFSObject args) {
		...
		player.getPlChar().setDown(false);
		SFSObject params = new SFSObject();
		params.putInt(GameOpcodes.ENTITY_ID_PARAM, player.getPlChar().getId());
		send(GameOpcodes.GAME_MOVE_DOWN_STOP, params, getParentExtension().getParentRoom().getPlayersList());
	}
