...
public class GameSkill1StopHandler extends BaseClientRequestHandler {
	...
	public void handleClientRequest(User user, ISFSObject args) {
		...
		send(GameOpcodes.GAME_SKILL1_STOP, params, getParentExtension().getParentRoom().getPlayersList());
	}
}
