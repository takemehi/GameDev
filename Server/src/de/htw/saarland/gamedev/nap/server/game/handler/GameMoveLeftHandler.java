...
public class GameMoveLeftHandler extends BaseClientRequestHandler {
	...
	public void handleClientRequest(User user, ISFSObject args) {
		...
		send(GameOpcodes.GAME_MOVE_LEFT_START, params, getParentExtension().getParentRoom().getPlayersList());
